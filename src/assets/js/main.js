...
$(document).ready(() => {
    ...
    $("form[name='step7']").validate({
        ...
        submitHandler: function(form) {
            ...
            $('.totalPrice').html(parseInt(totalData.amountCheckInProvince) + parseInt(totalData.amountCheckOutProvince) + parseInt(totalData.amountServiceType) + parseInt(totalData.amountTruckType));
        }
    });
